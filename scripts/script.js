...
const editFormFullName = document.querySelector(".edit-form__textinput_full-name");
const editFormDescription = document.querySelector(".edit-form__textinput_description");
